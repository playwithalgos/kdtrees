...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*points, undefined, Math, NIGHTMODE*/ 1) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function alignedWithExistingPoints(pt) {
    		...
    		for (const A of points) for (const B of points) if (A != B) {
    	...
    	function closeFromExistingPoints(pt) {
    		for (const A of points) if ((A.x - pt.x) ** 2 + (A.y - pt.y) ** 2 < 500) return true;
    		return false;
    	}
